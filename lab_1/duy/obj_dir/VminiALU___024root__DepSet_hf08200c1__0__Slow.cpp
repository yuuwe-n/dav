...
VL_ATTR_COLD void VminiALU___024root___eval_static(VminiALU___024root* vlSelf) {
...
#endif  // VL_DEBUG
VL_ATTR_COLD bool VminiALU___024root___eval_phase__stl(VminiALU___024root* vlSelf);

VL_ATTR_COLD void VminiALU___024root___eval_settle(VminiALU___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VminiALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
#endif
            VL_FATAL_MT("miniALU.sv", 3, "", "Settle region did not converge.");
        }
        __VstlIterCount = ((IData)(1U) + __VstlIterCount);
        __VstlContinue = 0U;
        if (VminiALU___024root___eval_phase__stl(vlSelf)) {
            __VstlContinue = 1U;
        }
...
VL_ATTR_COLD void VminiALU___024root___eval_stl(VminiALU___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VminiALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
VL_ATTR_COLD bool VminiALU___024root___eval_phase__stl(VminiALU___024root* vlSelf) {
    ...
    // Body
    VminiALU___024root___eval_triggers__stl(vlSelf);
    __VstlExecute = vlSelfRef.__VstlTriggered.any();
    if (__VstlExecute) {
        VminiALU___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void VminiALU___024root___ctor_var_reset(VminiALU___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VminiALU__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
