...
VL_INLINE_OPT void VminiALU_top_tb___024root___act_sequent__TOP__0(VminiALU_top_tb___024root* vlSelf) {
    ...
    vlSelfRef.miniALU_top_tb__DOT__displayBits = (((QData)((IData)(
                                                                   ((((IData)(miniALU_top_tb__DOT__uut__DOT__encoder_instance__DOT____Vcellout__digitDisplay5__displayBits) 
                                                                      << 0x18U) 
                                                                     | ((IData)(miniALU_top_tb__DOT__uut__DOT__encoder_instance__DOT____Vcellout__digitDisplay4__displayBits) 
                                                                        << 0x10U)) 
...
#endif
            VL_FATAL_MT("miniALU_top_tb.sv", 5, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("miniALU_top_tb.sv", 5, "", "Active region did not converge.");
            }
