...
VL_ATTR_COLD void VminiALU_tb___024root___dump_triggers__act(VminiALU_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @([changed] tb_miniALU_top.displayBits)\n");
    }
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @([changed] tb_miniALU_top.switches)\n");
    }
...
VL_ATTR_COLD void VminiALU_tb___024root___dump_triggers__nba(VminiALU_tb___024root* vlSelf) {
    ...
    if ((1ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @([changed] tb_miniALU_top.displayBits)\n");
    }
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @([changed] tb_miniALU_top.switches)\n");
    }
...
VL_ATTR_COLD void VminiALU_tb___024root___ctor_var_reset(VminiALU_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->tb_miniALU_top__DOT__switches = VL_RAND_RESET_I(10);
    vlSelf->tb_miniALU_top__DOT__displayBits = VL_RAND_RESET_Q(48);
    vlSelf->__Vtrigprevexpr___TOP__tb_miniALU_top__DOT__displayBits__0 = VL_RAND_RESET_Q(48);
    vlSelf->__Vtrigprevexpr___TOP__tb_miniALU_top__DOT__switches__0 = VL_RAND_RESET_I(10);
