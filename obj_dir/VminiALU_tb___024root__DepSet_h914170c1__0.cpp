...
VL_INLINE_OPT VlCoroutine VminiALU_tb___024root___eval_initial__TOP__Vtiming__0(VminiALU_tb___024root* vlSelf) {
    ...
    vlSelfRef.tb_miniALU_top__DOT__switches = 0x1bU;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "miniALU_tb.sv", 
                                         22);
    vlSelfRef.tb_miniALU_top__DOT__switches = 0x27U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "miniALU_tb.sv", 
                                         27);
    vlSelfRef.tb_miniALU_top__DOT__switches = 0x20U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "miniALU_tb.sv", 
                                         32);
    vlSelfRef.tb_miniALU_top__DOT__switches = 0x68U;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "miniALU_tb.sv", 
                                         37);
    vlSelfRef.tb_miniALU_top__DOT__switches = 0x3ffU;
    co_await vlSelfRef.__VdlySched.delay(0xaULL, nullptr, 
                                         "miniALU_tb.sv", 
                                         41);
    VL_FINISH_MT("miniALU_tb.sv", 43, "");
}
...
void VminiALU_tb___024root___eval_triggers__act(VminiALU_tb___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, (vlSelfRef.tb_miniALU_top__DOT__displayBits 
                                       != vlSelfRef.__Vtrigprevexpr___TOP__tb_miniALU_top__DOT__displayBits__0));
    vlSelfRef.__VactTriggered.set(1U, ((IData)(vlSelfRef.tb_miniALU_top__DOT__switches) 
                                       != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb_miniALU_top__DOT__switches__0)));
...
VL_INLINE_OPT void VminiALU_tb___024root___nba_sequent__TOP__0(VminiALU_tb___024root* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VminiALU_tb__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VminiALU_tb___024root___nba_sequent__TOP__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (VL_UNLIKELY(((~ (IData)(vlSymsp->TOP____024unit.__VmonitorOff)) 
                     & (1U == vlSymsp->TOP____024unit.__VmonitorNum)))) {
        VL_WRITEF_NX("Time=%0t | Switches=%b | DisplayBits=%b\n",0,
                     64,VL_TIME_UNITED_Q(1),-9,10,(IData)(vlSelfRef.tb_miniALU_top__DOT__switches),
                     48,vlSelfRef.tb_miniALU_top__DOT__displayBits);
    }
}
