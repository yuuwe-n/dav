...
extern const VlUnpacked<CData/*7:0*/, 16> VminiALU_top__ConstPool__TABLE_hdd8ed3e7_0;
...
VL_INLINE_OPT void VminiALU_top___024root___ico_sequent__TOP__0(VminiALU_top___024root* vlSelf) {
    ...
    miniALU_top__DOT__encoder_instance__DOT____Vcellout__digitDisplay0__displayBits 
        = VminiALU_top__ConstPool__TABLE_hdd8ed3e7_0
        [__Vtableidx1];
    ...
    miniALU_top__DOT__encoder_instance__DOT____Vcellout__digitDisplay5__displayBits 
        = VminiALU_top__ConstPool__TABLE_hdd8ed3e7_0
        [__Vtableidx6];
    vlSelfRef.displayBits = (((QData)((IData)(((((IData)(miniALU_top__DOT__encoder_instance__DOT____Vcellout__digitDisplay5__displayBits) 
                                                 << 0x18U) 
                                                | ((IData)(miniALU_top__DOT__encoder_instance__DOT____Vcellout__digitDisplay4__displayBits) 
                                                   << 0x10U)) 
